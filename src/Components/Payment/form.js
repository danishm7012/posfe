        ...
        <React.Fragment>
            ...
            <Grid container xs={12} style={{ padding: '0 250px 0 200px', marginTop: 50 }}>
                ...
                <Autocomplete
                    ...
                    getOptionLabel={(option) => history.location.pathname == "/customerpayment" ? option.customer_name : option.supplier_name}
                    onChange={(e, newValue) => {
                        setFirstName(newValue.customer_name)
                    }}
                    renderInput={(params) =>
                        <>
                            <div ref={params.InputProps.ref} style={{}}>
                                Name
                                <input style={{ height: 35, marginLeft: 157, width: 587, marginBottom: 10 }} type="text" placeholder='Name' {...params.inputProps} />
                            </div>
                        </>
                    }
                />
